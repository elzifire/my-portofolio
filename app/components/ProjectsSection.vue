  ...
  >
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        >
          <div 
            class="rounded-2xl overflow-hidden card-3d glass-card transition-all duration-300 h-full flex flex-col"
          >
...
const projects: Project[] = [
  {
    id: 1,
    title: t('projects.items.masjid.title'),
    description: t('projects.items.masjid.description'),
    ...
    status: 'completed',
    type: t('projects.items.masjid.type')
  },
  {
    id: 2,
    ...
    liveUrl: 'https://muhammad-ali-ghozi.vercel.app',
  ...
  {
    id: 3,
    title: t('projects.items.akps.title'),
    description: t('projects.items.akps.description'),
    ...
    status: 'completed',
    type: t('projects.items.akps.type')
  },
  {
    id: 4,
    title: t('projects.items.complain.title'),
    description: t('projects.items.complain.description'),
    ...
    status: 'completed',
    type: t('projects.items.complain.type')
  },
  {
    id: 5,
    ...
    // githubUrl: 'https://github.com',
    status: 'completed',
    type: t('projects.items.landing.type')
  },
  {
    id: 6,
    title: t('projects.items.setoran.title'),
    description: t('projects.items.setoran.description'),
    ...
    status: 'completed',
    type: t('projects.items.setoran.type')
  },
]
